...
The site reflects the public Android app v1.2.2 release, including restored Fruit and new Bread categories with their icons, more reliable ChatGPT and Gemini recipe generation, clearer API-key settings, GPT-5.6 Luna, updated Google Play Billing compatibility, broader ingredient consideration, generated-model labels, and refined history restore. Mottainai Premium and Local AI are not currently available.
